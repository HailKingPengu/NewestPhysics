...
namespace Volatile
{
  public struct VoltAABB
  {
    ...
    public static VoltAABB CreateSwept(VoltAABB source, Vec2 vector)
    {
    ...
    public Vec2 TopLeft 
    { 
      get { return new Vec2(this.left, this.top); } 
    }

    public Vec2 TopRight 
    { 
      get { return new Vec2(this.right, this.top); } 
    }

    public Vec2 BottomLeft 
    { 
      get { return new Vec2(this.left, this.bottom); } 
    }

    public Vec2 BottomRight 
    { 
      get { return new Vec2(this.right, this.bottom); } 
    }
    ...
    public Vec2 Center { get { return this.ComputeCenter(); } }
    public Vec2 Extent 
    { 
      get { return new Vec2(this.Width * 0.5f, this.Height * 0.5f); } 
    }
    ...
    /// </summary>
    public bool QueryPoint(Vec2 point)
    {
      return 
        this.left <= point.x && 
        this.right >= point.x &&
    ...
    /// </summary>
    public bool QueryCircleApprox(Vec2 origin, float radius)
    {
      return
    ...
    public VoltAABB(Vec2 center, Vec2 extents)
    {
      Vec2 topRight = center + extents;
      Vec2 bottomLeft = center - extents;
    ...
    public VoltAABB(Vec2 center, float radius)
      : this (center, new Vec2(radius, radius))
    {
    }

    public VoltAABB ComputeTopLeft(Vec2 center)
    {
      return new VoltAABB(this.top, center.y, this.left, center.x);
    }

    public VoltAABB ComputeTopRight(Vec2 center)
    {
      return new VoltAABB(this.top, center.y, center.x, this.right);
    }

    public VoltAABB ComputeBottomLeft(Vec2 center)
    {
      return new VoltAABB(center.y, this.bottom, this.left, center.x);
    }

    public VoltAABB ComputeBottomRight(Vec2 center)
    {
      return new VoltAABB(center.y, this.bottom, center.x, this.right);
    }

    private Vec2 ComputeCenter()
    {
      return new Vec2(
    ...
    public void GizmoDraw(Color aabbColor)
    {
      ...
      Vec2 A = new Vec2(this.Left, this.Top);
      Vec2 B = new Vec2(this.Right, this.Top);
      Vec2 C = new Vec2(this.Right, this.Bottom);
      Vec2 D = new Vec2(this.Left, this.Bottom);
